...
const EDA_Graph = () => {
  ...
  const roomTypePriceDistributionData = {
    labels: [...new Set(roomTypes)],
    datasets: [
      {
        label: "Price Distribution by Room Type",
  ...
  const graphs = [
    ...
    },
    {
      ...
      description: [
        "Box plot comparing price ranges for different room types.",
      ],
      component: (
        <Bar data={roomTypePriceDistributionData} options={chartOptions} />
      ),
    },
    {
